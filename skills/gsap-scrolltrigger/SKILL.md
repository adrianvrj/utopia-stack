...
**Related skills:** For tweens and timelines use **gsap-core** and **gsap-timeline**; for React cleanup use **gsap-react**. Flip, Draggable, Vue/Svelte, utils, and the performance skill are not bundled.
