...
**Related skills:** For sequencing multiple steps use **gsap-timeline**; for scroll-linked animation use **gsap-scrolltrigger**; for React use **gsap-react**. Flip, Draggable, Vue/Svelte, utils, and the performance skill are not bundled.
