...
3. Plan the fix. If the change introduces or changes a type, module, or ownership boundary, or the user asked to architect, `architect` first. Not every function-crossing edit. Delegate implementation to a subagent using your configured bug-fix model (default `gpt-5.6-sol-max`) with a specific scope; review the diff.
