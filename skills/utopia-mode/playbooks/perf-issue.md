...
1. Capture a baseline trace via the matching control skill. If `control-ui` or `control-cli` is missing, drive the surface with the available browser tools, or ask in plain words.
