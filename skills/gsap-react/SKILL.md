...
**Related skills:** For tweens and timelines use **gsap-core** and **gsap-timeline**; for scroll-based animation use **gsap-scrolltrigger**. Flip, Draggable, Vue/Svelte, utils, and the performance skill are not bundled.
