...
**Playbook override.** When invoked from the UI design playbook: comps already exist. Do not regenerate. On Cursor, images come from `GenerateImage` or the prior imagegen step, not Codex.
